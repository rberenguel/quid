...
- Prune. You need a dictionary for the language, too. I have copied mine from [mots](https://github.com/rberenguel/mots)
  - `go run pruner.go cc.LANG.50.txt words_LANG.txt 50000`
